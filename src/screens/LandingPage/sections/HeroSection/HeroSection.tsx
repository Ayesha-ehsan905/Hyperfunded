...
export const HeroSection = () => {
  ...
  return (
    <section className="relative w-full hf-gradient-hero overflow-hidden">
      ...
      {/* Navigation Bar */}
      <nav className="relative z-10 w-full flex items-center justify-center gap-12 px-20 py-4 border-t-[1.5px] border-b-[1.5px] border-border">
        {/* Logo */}
        ...
        <div className="flex items-center justify-center gap-6 flex-1">
          {navLinks.map((link) => (
            <button
              key={link.label}
              className="inline-flex items-center justify-center gap-1 px-4 py-3 rounded-[999px] hover:text-fg transition-colors"
            >
              <span className="hf-label text-muted whitespace-nowrap">
                {link.label}
              </span>
            </button>
          ))}
        ...
        <div className="inline-flex items-center gap-8 flex-shrink-0">
          {/* Theme toggle */}
          <div className="flex w-12 h-12 items-center justify-center gap-2.5 p-2 bg-surface rounded-3xl border border-solid border-border">
            <img className="w-8 h-8" alt="Moon" src="/moon.svg" />
          </div>
        ...
        <div className="max-w-[876px] w-full flex flex-col items-center gap-12">
          ...
          <div className="flex items-center justify-center gap-4 w-full">
            ...
            <button className="inline-flex items-center justify-center gap-2 p-4 rounded-[999px] border border-solid border-fg">
              <img className="w-6 h-6" alt="Video new" src="/video-new.svg" />
              <span className="[font-family:'Inter',Helvetica] font-semibold text-fg text-base tracking-[0] leading-5">
                Watch How it Works
              </span>
            </button>
            ...
            <Card className="flex max-w-[484px] w-full items-center gap-4 px-6 py-4 bg-page rounded-xl border border-solid border-border">
              <CardContent className="p-0 flex items-center gap-4 w-full">
                ...
                <div className="flex flex-col items-start flex-1">
                  <span className="hf-kpi-lg text-fg">
                    12000+
                  </span>
